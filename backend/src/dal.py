# (Data access layer)this file handles interactions with mongodb database
from bson import ObjectId # handle mongodb objectId
from motor.motor_asyncio import AsyncIOMotorCollection 
from pymongo import ReturnDocument # specify return behavior and update ops.

from pydantic import BaseModel # create data models with validation
