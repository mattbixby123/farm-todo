...
# created FastAPI appilication with lifespan manager that we define above
...
# runs the FastApi application using uvicorn, when this script is executed directly
